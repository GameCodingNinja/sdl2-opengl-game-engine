...
#define SOIL_CHECK_FOR_GL_ERRORS 0
    ...
    #define APIENTRY
#elif defined(__IPHONEOS__) || defined(__ANDROID__) || defined(__arm__)
        ...
        int loading_as_cubemap )
{
    ...
    bytes_read = SDL_RWread( f, (void*)buffer, 1, buffer_length );
    SDL_RWclose( f );
...
int query_DXT_capability( void )
{
    ...
    if( has_DXT_capability == SOIL_CAPABILITY_UNKNOWN )
    {
        ...
        if( (NULL == strstr(pChar, "GL_OES_texture_compression_S3TC" )) &&
            (NULL == strstr(pChar, "GL_EXT_texture_compression_s3tc" )) )
        {
            /*	not there, flag the failure	*/
        ...
        else
        {
            ...
            P_SOIL_GLCOMPRESSEDTEXIMAGE2DPROC ext_addr = NULL;
                ...
                CFRelease( bundle );
            #elif defined(__IPHONEOS__) || defined(__ANDROID__) || defined(__arm__)
            // No support for hardware compression
            #else
                ext_addr = (P_SOIL_GLCOMPRESSEDTEXIMAGE2DPROC)
